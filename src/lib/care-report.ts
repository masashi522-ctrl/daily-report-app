...
・健康や安全に関わる記録がある場合は、その中からお伝えしたい事柄を1つだけ選び、①デイで実際に観察された具体的な事実（日付・部位・状況など）、②介護職員・機能訓練指導員としての見解（原因の推測や状態の解釈）、③デイでの対応内容、④ご自宅での様子や対応について確認・共有をお願いする一文、の4つを1つの段落の中に自然な流れで盛り込むこと
・④は「ご自宅での○○について、ケアマネジャー様からもご確認いただけますと幸いです。」のように、具体的に何を確認してほしいかが分かる形で必ず含めること
・④の依頼先は必ず「ケアマネジャー様」とすること。この報告書の読み手はケアマネジャーであり、ご家族に直接お願いする書き方（「ご家族の方にもご確認いただけますと幸いです」など）はしないこと
